...
Cypress.Commands.add('login', (email = 'demo@mobilify.com', password = 'demo123') => {
  cy.visit('/login');
...
Cypress.Commands.add('seedTestData', () => {
  ...
  cy.get('[data-testid="seed-success-message"]', { timeout: 15000 }).should('be.visible');
});
...
Cypress.Commands.add('clearTestData', () => {
  ...
  cy.get('[data-testid="clear-success-message"]', { timeout: 15000 }).should('be.visible');
});
