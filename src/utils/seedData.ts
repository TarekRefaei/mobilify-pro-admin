...
const cairoBitesMenuItems: Omit<MenuItem, 'id' | 'createdAt' | 'updatedAt'>[] =
  [
    // Main Courses
    {
      name: 'Koshari',
      description:
        'Traditional Egyptian rice dish with lentils, pasta, and spicy tomato sauce (كشري)',
      price: 50,
    ...
    },
    {
      name: 'Mahshi',
      description:
        'Stuffed vegetables with rice and herbs - zucchini, eggplant, and peppers (محشي)',
      price: 65,
      category: 'Main Course',
      imageUrl:
    ...
    },
    {
      ...
      description:
        'Traditional green soup with tender chicken pieces and rice (ملوخية بالفراخ)',
      price: 75,
      category: 'Main Course',
      imageUrl:
    ...
    },
    {
      name: 'Grilled Kofta',
      description:
        'Seasoned ground meat grilled to perfection, served with rice and salad (كفتة مشوية)',
      price: 80,
      category: 'Main Course',
      imageUrl:
    ...
    // Breakfast Items
    {
      name: 'Ful Medames',
      description:
        'Egyptian fava beans with tahini, olive oil, and fresh vegetables (فول مدمس)',
      price: 30,
      category: 'Breakfast',
      imageUrl:
    ...
    },
    {
      ...
      description:
        'Eggs poached in spiced tomato sauce with Egyptian herbs (شكشوكة)',
      price: 40,
      category: 'Breakfast',
      imageUrl:
    ...
    },
    {
      ...
      description:
        'Fresh white cheese with natural honey and warm baladi bread (جبنة وعسل)',
      price: 35,
      category: 'Breakfast',
      imageUrl:
    ...
    // Appetizers
    {
      ...
      description:
        'Hummus, baba ganoush, tahini, and fresh vegetables (مقبلات مشكلة)',
      price: 45,
      category: 'Appetizers',
      imageUrl:
    ...
    },
    {
      name: 'Egyptian Salad',
      description:
        'Fresh tomatoes, cucumbers, onions with Egyptian dressing (سلطة مصرية)',
      price: 25,
      category: 'Appetizers',
      imageUrl:
    ...
    },
    {
      name: 'Baba Ganoush',
      description:
        'Smoky grilled eggplant dip with tahini and garlic (بابا غنوج)',
      price: 30,
      category: 'Appetizers',
      imageUrl:
        'https://images.unsplash.com/photo-1571197119282-7c4e2b8b3d8e?w=400',
      isAvailable: true,
      displayOrder: 3,
      restaurantId: 'demo-restaurant-123',
    },
    ...
    // Desserts
    {
      name: 'Om Ali',
      description:
        'Traditional Egyptian bread pudding with nuts and raisins (أم علي)',
      price: 35,
      category: 'Desserts',
      imageUrl:
    ...
    },
    {
      name: 'Egyptian Tea',
      description:
        'Traditional black tea with mint, served in glass (شاي مصري)',
      price: 10,
      category: 'Beverages',
      imageUrl:
    ...
    },
    {
      name: 'Turkish Coffee',
      description:
        'Rich and aromatic coffee served in traditional style (قهوة تركية)',
      price: 15,
      category: 'Beverages',
      imageUrl:
...
const cairoBitesCategories: Omit<
  MenuCategory,
...
const generateCairoBitesOrders = (): Omit<Order, 'id'>[] => {
  ...
  for (let i = 0; i < 20; i++) {
    ...
    const totalPrice = randomItems.reduce(
      (sum, item) => sum + item.price * (Math.random() > 0.7 ? 2 : 1),
      0
    );
    ...
    const orderData: Omit<Order, 'id'> = {
      customerName,
      customerPhone: `+201${Math.floor(Math.random() * 100000000)
        .toString()
        .padStart(8, '0')}`,
...
export const seedDatabase = async () => {
  try {
    ...
    console.log(
      `📊 Added ${cairoBitesCategories.length} categories, ${cairoBitesMenuItems.length} menu items and ${orders.length} orders`
    );
