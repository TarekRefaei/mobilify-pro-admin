...
export const CustomerLoyaltyList: React.FC<CustomerLoyaltyListProps> = ({
  ...
  const [sortBy, setSortBy] = useState<
    'name' | 'stamps' | 'lastPurchase' | 'totalSpent'
  >('stamps');
    ...
    return (
      <Card className="p-8 text-center">
        ...
        <p className="text-gray-600">
          Customer loyalty data will appear here once customers start making
          purchases.
        </p>
      </Card>
    );
    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="flex gap-2">
            <select
              value={sortBy}
              onChange={e =>
                setSortBy(e.target.value as 'stamps' | 'name' | 'joinDate')
              }
      ...
      <div className="space-y-4">
        {filteredCustomers.map(customerLoyalty => {
          const customer = customerLoyalty.customer;
          const { completed, current } = getStampDisplay(
                ...
                <div className="flex-1 space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between text-xs text-gray-500">
                      <span>
                        {loyaltyProgram.purchasesRequired - current} more for
                        next reward
                      </span>
                      {completed > 0 && (
                      ...
                      {Array.from(
                        {
                          length: Math.max(
                            0,
                            loyaltyProgram.purchasesRequired - current
                          ),
                        },
                        (_, i) => (
                          <Star
